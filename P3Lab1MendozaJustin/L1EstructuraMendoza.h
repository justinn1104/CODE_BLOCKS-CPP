...
#include "L3RegistroMendoza.h"
using namespace std;
void Caratula();
void MenuFunciones();
void Caratula(){
    string portada1[8]={"UNIDAD : ","Integrantes : ","Carrera : ","Asignatura : ","Docente : ","Tema : ","Fecha : ","Periodo : "};
    string portada2[8]={"Univesidad de las fuerzas armadad espe-ss","Justin Mendoza","Ingenieria de tecnologias de la informacion","Fundamentos de Programcion","Ing. Veronica Martinez","P3 LAB 1","18-02-24","202351 - NOV23 - MAR24"};
	cout << "\n============================================================" << endl;
    for(int i=0; i<8; i++){
...
void MenuFunciones(){
    ...
    cout << "[8] Registro Univesidad" << endl;
    cout << "[9] Salir" << endl;
    cout << "============================================================\n" << endl;
